        ...
        for (int i = -size / 2; i < size / 2; i++)
        {
            for (int j = -size / 2; j < size / 2; j++)
            {
                glPushMatrix();
                    ...
                    if ((i+j) % 2 == 0) glColor3f (0.8, 0.8, 0);
        ...
        else
        {
            ...
            glPushMatrix();
                ...
                glPushMatrix(); //Непрозрачная фигура
                    ...
                    drawPrism(5, 1.0f, 1.0f);
                glPopMatrix();

                 glPushMatrix();
                    glTranslatef(1.5f, 3.0f, 0.0f);
                    glColor4f(0.0f, 0.5f, 0.5f, 0.82f);
                    drawPrism(5, 1.0f, 1.0f);
                glPopMatrix();

                glPushMatrix();
                    glTranslatef(-1.5f, 3.0f, 0.0f);
                    glColor4f(0.0f, 0.5f, 0.5f, 0.68f);
                    drawPrism(5, 1.0f, 1.0f);
                glPopMatrix();

                glPushMatrix();
                    glTranslatef(-3.0f, 0.0f, 0.0f);
                    glColor4f(0.0f, 0.5f, 0.5f, 0.51f);
                    drawPrism(5, 1.0f, 1.0f);
                glPopMatrix();

                 glPushMatrix();
                    glTranslatef(-1.5f, -3.0f, 0.0f);
                    glColor4f(0.0f, 0.5f, 0.5f, 0.34f);
                    drawPrism(5, 1.0f, 1.0f);
                glPopMatrix();

                glPushMatrix();//Прозрачная фигура
                    glTranslatef(1.5f, -3.0f, 0.0f);
                    glColor4f(0.0f, 0.5f, 0.5f, 0.17f);
                    drawPrism(5, 1.0f, 1.0f);
                glPopMatrix();
